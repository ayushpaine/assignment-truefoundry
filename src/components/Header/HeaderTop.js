...
const HeaderTop = () => {
  ...
  const handleClickInside = () => setColor("black");
      ...
      <div className="header-top-wrapper">
        <div className="header-top-left">
          ...
          <div className="button-wrapper-logo">
            <div className="button-wrapper-logo-img"></div>
          </div>
          {menuItems.map((item) => {
            return (
        ...
        <div className="header-top-right">
          <div className="searchbar-wrapper">
            <div className="icon-wrapper">
              <SearchIcon style={{ height: "17px", color: color }} />
            </div>
            <input
              class="searchbar"
              readonly
          ...
          <div className="end-buttons">
            <div className="button-icon-wrapper-end">
              <div className="button-icon-end">
                <InfoOutlinedIcon style={{ height: "19px" }} />
              </div>
              <div className="button-icon-end">
                <NotificationsOutlinedIcon style={{ height: "19px" }} />
              </div>
            </div>
          </div>
          <div className="profile-avatar">QK</div>
        </div>
      </div>
    </>
  );
